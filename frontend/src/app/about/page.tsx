...
export const metadata: Metadata = {
  title: 'About Us - RecruitLeads',
  description: 'Learn about RecruitLeads, our mission, values, and the team behind the leading recruitment lead generation platform.',
};
        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Empowering recruitment agencies with innovative lead generation solutions.
            </p>
          </div>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-8 text-center text-gray-900">Our Mission</h2>
            <p className="text-xl text-gray-600 mb-12 text-center">
              At RecruitLeads, we're on a mission to revolutionize how recruitment agencies find and connect with potential clients. We believe that every great business relationship starts with the right connection, and we're here to make those connections happen.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Maintaining the highest standards of integrity and reliability.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-12">
              <div className="flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="w-full md:w-1/2">
                  ...
                  <p className="text-gray-600 mb-4">
                    Founded in 2020, RecruitLeads emerged from a simple observation: recruitment agencies needed a better way to find and qualify potential clients. Our founders, coming from both recruitment and technology backgrounds, set out to create a solution that would transform the industry.
                  </p>
                  <p className="text-gray-600">
                    What started as a simple idea has grown into a comprehensive platform that helps recruitment agencies across the globe find and connect with their ideal clients.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col-reverse md:flex-row items-center gap-8">
                <div className="w-full md:w-1/2">
                  <h3 className="text-2xl font-semibold mb-4 text-gray-900">Growth & Innovation</h3>
                  <p className="text-gray-600 mb-4">
                    Over the years, we've continuously evolved our platform, incorporating cutting-edge technologies and listening to our clients' needs. From advanced search capabilities to AI-powered lead scoring, we've consistently pushed the boundaries of what's possible in recruitment lead generation.
                  </p>
                  <p className="text-gray-600">
                    Today, we're proud to serve thousands of recruitment agencies worldwide, helping them grow their businesses and make meaningful connections.
                  </p>
                </div>
                <div className="w-full md:w-1/2">
                  <img 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <img 
                ...
                className="w-32 h-32 rounded-full mx-auto mb-4"
              />
              <h3 className="text-xl font-semibold mb-1 text-gray-900">Emily Rodriguez</h3>
            ...
            <div className="text-center">
              <img 
                ...
                className="w-32 h-32 rounded-full mx-auto mb-4"
              />
              <h3 className="text-xl font-semibold mb-1 text-gray-900">David Thompson</h3>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              We're always looking for talented individuals to join our mission of transforming recruitment lead generation.
            </p>
            <Link 
              href="/careers" 
